...
CREATE TABLE IF NOT EXISTS persona_content (
  ...
  content_type text NOT NULL, -- 'video', 'audio', 'text', 'image', 'social_media'
  file_url text,
  file_name text,
  file_size bigint,
  content_text text,
...
CREATE TABLE IF NOT EXISTS conversations (
  ...
  persona_id uuid REFERENCES personas(id) ON DELETE CASCADE,
  title text,
  conversation_type text DEFAULT 'chat', -- 'chat', 'video_call', 'voice_call'
...
CREATE TABLE IF NOT EXISTS messages (
  ...
  sender_type text NOT NULL, -- 'user' or 'persona'
